...
#Create SVM classifier with sigmoid kernel function
...
print('Accuracy Sigmoid Kernel:', metrics.accuracy_score(y_test, sig_pred))
print("Confusion Matrix:\n",metrics.confusion_matrix(y_test, sig_pred))
print("Classification Report:\n:",metrics.classification_report(y_test, sig_pred))